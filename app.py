...
def process_value(value):
    # Access the passed value and print it
    print("Received value:", value)
    return "Received value: {}".format(value)
...
def place_order():
    ...
    if request.method == 'POST':
        ...
        order_id = payment['id']
        return render_template('pay.html', order_id=order_id, name=customer_name, email=email_id, contact=customer_contact, amount=amount,key=test_key)
...
def payment_success():
    ...
    query = "INSERT INTO orders (order_id, customer_name, customer_email, customer_contact, payment_id, razorpay_signature, total_amount, order_details,Table_id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,01)"
